...
const Sidebar = ({ activeMenu, setActiveMenu, setShowAdd, showAdd }) => {
  const [open, setOpen] = React.useState(true) // mặc định mở Scene Information

  return (
    <div className="w-72 bg-white rounded-l-xl shadow-md p-4 flex flex-col">
      ...
      {open && (
        <ul className="ml-6 mt-2 text-sm">
          ...
          <li className="mb-1">Images and Videos</li>
