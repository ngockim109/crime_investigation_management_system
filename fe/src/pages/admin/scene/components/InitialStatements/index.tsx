...
import AddInitialStatement from "./InitialStatementsForm"
...
const InitialStatement = ({}: Props) => {
  ...
  const { data: partiesData, isLoading: isLoadingParties, error: partiesError } = useQuery({
  ...
  const [deleteType, setDeleteType] = useState<'statement' | 'party' | null>(null);
  ...
  return (
    <section className="mb-6">
      <div className="bg-white rounded-lg shadow border">
        ...
        <div className="p-4">
          {isLoadingParties ? 'Loading...' : partiesError ? (
