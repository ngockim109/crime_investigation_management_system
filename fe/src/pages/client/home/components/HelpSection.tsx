...
const HelpSection: React.FC = () => {
    ...
    return (
        <section className=" mx-auto my-8 text-center">
            ...
            <button
                className="my-16 bg-blue-700 cursor-pointer hover:bg-blue-600 text-white hover:text-white text-2xl font-semibold px-8 py-4 h-16 w-3xs rounded-2xl cursor-pointer"
