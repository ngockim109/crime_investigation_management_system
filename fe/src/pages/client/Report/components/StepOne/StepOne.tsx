        ...
        return (
            <>
                <label htmlFor={v} className="flex mt-6.25 items-center space-x-3.75">
                    <input id={v} type="radio" name="relationshipIncident" className="size-5" />
                    <p>{v}</p>
                </label>
            </>
        )
        ...
        <div className={p.cur == 1 ? "" : "hidden"}>
            <div className="grid grid-cols-2 gap-x-15 mb-25 gap-y-7.5">
                <div className="flex flex-col text-[20px]  space-y-3.25">
                    ...
                    <input type="text" id="fullname" className="w-95 px-2 bg-[#EEEEEE] rounded-[8px] h-12.5" />
                </div>
                <div className="flex flex-col text-[20px] space-y-3.25">
                    <label htmlFor="email">
                        <p className="">
                    ...
                    <input type="email" id="email" className="w-95 px-2 bg-[#EEEEEE] rounded-[8px] h-12.5" />
                </div>
                <div className="flex flex-col text-[20px] space-y-3.25">
                    ...
                    <input type="tel" id="phonenumber" className="w-95 px-2 bg-[#EEEEEE] rounded-[8px] h-12.5" />
                </div>
                <div className="flex flex-col text-[20px] space-y-3.25">
                    ...
                    <input type="text" id="Address" className="w-95 px-2 bg-[#EEEEEE] rounded-[8px] h-12.5" />
                </div>
