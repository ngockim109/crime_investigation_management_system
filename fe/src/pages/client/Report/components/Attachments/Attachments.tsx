                        ...
                        <div>
                            {
                                url == "" ?
                                    <>
                                        <div><CloudUpload className="size-16 mx-auto" /></div>
                                        <p className="text-[16px] font-bold mt-3.75 text-center">Drag & drop files or <span className="text-blue-400">Browse</span></p>
                                        <p className="leading-4.5 text-[12px] mt-1 text-center">Supported formates: JPEG, PNG, GIF, MP4, PDF, PSD, AI, Word, PPT</p>
                                    </> : <>
