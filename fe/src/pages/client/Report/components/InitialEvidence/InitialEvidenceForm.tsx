    ...
    <>
      <div className="fixed top-0 left-1/2 z-40  -translate-x-1/2 p-1 ">
        <div className="bg-white overflow-y-auto h-screen w-250 rounded-4xl p-17.5">
          ...
          <p className="text-[11px] italic text-center leading-3.5">
          ...
          <div className="mt-12.5 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-15  gap-y-7.5">
            <div className="flex flex-col text-[20px]  space-y-3.25">
              ...
              >
                ...
                <SelectContent>{selectEvidenceType}</SelectContent>
              </Select>
            </div>
            <div className="flex flex-col text-[20px]  space-y-3.25">
              ...
              <input
                onChange={(v) => {
                  setDataForm({
                    ...data,
                    current_location: v.currentTarget.value,
                  })
                }}
                type="text"
                id="Nationality"
            ...
            <div className="flex col-span-2 flex-col text-[20px]  space-y-3.25">
              <label htmlFor="DescriptionEvidence">
                <p className="">Evidence Description</p>
              </label>
              <textarea
                onChange={(v) => {
                  setDataForm({
            ...
            <div className="flex col-span-2 flex-col text-[20px]  space-y-3.25">
              <Attachments
                key={data.attached_file.length}
                idimage="InitialEvidenceForm"
                onchange={(file) => {
                  setFile(file)
                }}
              />
          ...
          <div className="mt-5.25 flex">
            ...
            <div className="ml-3">
              ...
              <svg className="mr-3 size-5 animate-spin ..." viewBox="0 0 24 24">
                <div className="size-4 rounded-full border-2 border-black"></div>
              </svg>
            </div>
          </div>
                      ...
                      return (
                        <FileForm
                          ...
                          rm={() => {
                            setDataForm({
                              ...data,
                              attached_file: data.attached_file.filter(
                                (_, ati) => {
                                  return ati != i
                                }
                              ),
                ...
                <AlertDialogHeader>
                  ...
                  <div>
                    <AlertDialogDescription asChild>
                      <p>
                        {" "}
                        1. I hereby declare that all the information provided in
