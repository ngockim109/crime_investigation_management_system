...
const InitialEvidenceTable = () => {
  ...
  const initialEvidence = useSelector(
    (state: RootState) => state.report.evidences
  )
    ...
    <section className="mb-33.5">
      <div className="max-w-250 mx-auto mb-12.5">
        <div className="flex items-center gap-x-8.25">
          <hr className="flex-1" />
          <h2 className="text-[26px] font-semibold">Initial Evidence</h2>
          <hr className="flex-1" />
        </div>
      </div>
              ...
              <div>
                <AlertDialogDescription asChild>
                  <p>
                    {" "}
                    <AlertDialogDescription asChild>
                      <p className="mt-4">Delete Successfully</p>
                    </AlertDialogDescription>
                  </p>
                </AlertDialogDescription>
              </div>
