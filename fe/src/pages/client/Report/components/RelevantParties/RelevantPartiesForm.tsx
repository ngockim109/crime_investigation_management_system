      ...
      <div className="fixed top-0 left-1/2 z-40  -translate-x-1/2 p-1 ">
        <div className="bg-white overflow-y-auto h-[96vh] lg:w-250 rounded-4xl p-17.5">
          ...
          <p className="text-[11px] italic text-center leading-3.5">
            This form is used to document the roles and identities of all
          ...
          <div className="mt-12.5 lg:grid grid-cols-1 lg:grid-cols-2 lg:gap-x-15  gap-y-7.5">
            ...
            <div className="flex flex-col text-[20px]  space-y-3.25">
              ...
              >
                ...
                <SelectContent>{selectRelationship}</SelectContent>
              </Select>
            </div>
            <div className="flex flex-col text-[20px]  space-y-3.25">
              <label htmlFor="fullname">
              ...
              >
                ...
                <SelectContent>{selectGender}</SelectContent>
              </Select>
            </div>
            <div className="flex flex-col text-[20px]  space-y-3.25">
                    ...
                    return (
                      <FileForm
                        ...
                        rm={() => {
                          setDataForm({
                            ...dataForm,
                            attached_file: dataForm.attached_file.filter(
                              (_, ati) => {
                                return ati != i
                              }
                            ),
