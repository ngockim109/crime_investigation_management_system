        ...
        <div>
          <div className="flex gap-4">
            ...
            <div className=" relative bg-[#616161] rounded-[8px] flex-1">
              ...
              <input
                type="text"
                className="h-full text-sm font-normal w-full focus:outline-none"
              />
            </div>
          </div>
          <div className="mt-3">
            <div className="">
              <p className="text-sm font-normal">
                {" "}
                City of New York. 2025 All Rights Reserved, NYC is a trademark
                and service mark of the City of New York
              </p>
            </div>
          </div>
        </div>
